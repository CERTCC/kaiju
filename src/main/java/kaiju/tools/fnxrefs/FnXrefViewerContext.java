...
public class FnXrefViewerContext extends DefaultActionContext implements DataLocationListContext {
    ...
    FnXrefViewerContext(FnXrefViewerProvider provider, GhidraTable stringsTable) {
        super(provider, stringsTable);
        xrefViewerProvider = provider;
    }
    ...
    @Override
    public int getCount() {
        return xrefViewerProvider.getSelectedRowCount();
    }

    @Override
    public Program getProgram() {
        return xrefViewerProvider.getProgram();
    }

    @Override
    public List<ProgramLocation> getDataLocationList() {
        return xrefViewerProvider.getSelectedDataLocationList(null);
    }

    @Override
    public List<ProgramLocation> getDataLocationList(Predicate<Data> filter) {
        return xrefViewerProvider.getSelectedDataLocationList(filter);
    }
}
